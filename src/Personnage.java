...
public class Personnage{
	//Attributs
	int PointsVie = 100;	//Points de vie courants du personnage
	int degats = 10;		//Dégats par défaut du personnage
	int pos_x;
	int pos_y;
	//Constructeur
	public Personnage(){
	...
	//Retourne 1 si le déplacement est possible et que la position a été mise à jour,
	//0 sinon.
